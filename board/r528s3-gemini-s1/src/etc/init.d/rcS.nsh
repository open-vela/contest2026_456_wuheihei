...
#ifdef CONFIG_AE_AUDIODETECT_UI_AUTOSTART
/* Keep the factory service order and avoid overlapping LCD, microphone,
 * Wi-Fi and Bluetooth power-up current during a cold boot. */
echo "Waiting for Audio Sentinel hardware..."
sleep 3
audiodetect ui &
#endif
